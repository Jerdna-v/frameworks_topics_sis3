...
`;
// Add near other CREATE TABLE statements:
                    ...
                    conn.query(createReportTotalsTable, (err) => {
                      ...
                      conn.query(createPriceBandsTable, (err) => {
                        ...
                        conn.query(createCoinMechDataTable, (err) => {
                          if (err) return reject(err);
                          conn.query(createMechanicalTable, (err) => {
                            if (err) return reject(err);
                            conn.query(createServiceTable, (err) => {
                              if(err) return reject(err);
...
// Add under "PRODUCT (INVENTORY)" or create a new section:
/* ===================== SERVICE LOG ===================== */

dataPool.addService = (dateTime, mid, uid, description) => {
  return new Promise((resolve, reject) => {
    const sql = `
      INSERT INTO Service (date_time, mid, uid, description)
      VALUES (?, ?, ?, ?)
    `;
    conn.query(sql, [dateTime, mid, uid, description], (err, res) =>
      err ? reject(err) : resolve(res)
    );
  });
};

dataPool.listService = (midOrNull) => {
  return new Promise((resolve, reject) => {
    const sql = midOrNull
...
dataPool.addMechanical = (dateTime, mid, uid, mechanical) => {
  return new Promise((resolve, reject) => {
    const sql = `
      INSERT INTO Mechanical (date_time, mid, uid, mechanical)
      VALUES (?, ?, ?, ?)
    `;
    conn.query(sql, [dateTime, mid, uid, mechanical], (err, res) =>
      err ? reject(err) : resolve(res)
    );
  });
};
...
dataPool.listMechanical = (midOrNull) => {
  return new Promise((resolve, reject) => {
    const sql = midOrNull
...
// ne iskljucvaj slobodno raboti si
...
dataPool.addCashFlow = (dateTime, mid, uid, cashType, amount, description = null) => {
  return new Promise((resolve, reject) => {
    const sql = `
      INSERT INTO CashFlow (date_time, mid, uid, cashflow_type, cash_amount, description)
      VALUES (?, ?, ?, ?, ?, ?)
    `;
    conn.query(sql, [dateTime, mid, uid, cashType, amount, description], (err, res) =>
      err ? reject(err) : resolve(res)
    );
  });
};

dataPool.addCashFlowBulk = (dateTime, mid, uid, items) => {
  return new Promise((resolve, reject) => {
...
dataPool.addProductBulk = (dateTime, mid, uid, products) => {
  return new Promise((resolve, reject) => {
...
dataPool.addProduct = (dateTime, mid, uid, productType, grams, description = null) => {
  return new Promise((resolve, reject) => {
    const sql = `
      INSERT INTO Product (date_time, mid, uid, product_type, product_amount, description)
      VALUES (?, ?, ?, ?, ?, ?)
